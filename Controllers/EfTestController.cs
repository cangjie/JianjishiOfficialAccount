...
namespace OA.Controllers
{
    ...
    public class EfTestController : ControllerBase
    {
        ...
        public EfTestController(SqlServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EfTest>> PostEfTest(EfTest efTest)
        {
          if (_context.EfTest == null)
          {
              return Problem("Entity set 'SqlServerContext.EfTest'  is null.");
          }
        ...
        {
            return (_context.EfTest?.Any(e => e.id == id)).GetValueOrDefault();
        }
    }
}
